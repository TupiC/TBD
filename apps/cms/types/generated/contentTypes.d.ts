...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    closed_days: Schema.Attribute.Component<'shared.closed-day', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dogs_allowed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    free_access: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    geo: Schema.Attribute.Component<'shared.geo-coordinates', false>;
    hero_image: Schema.Attribute.String;
    ...
    opened_months: Schema.Attribute.Component<'shared.month', false>;
    opening_all_year: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    trips: Schema.Attribute.Relation<'manyToMany', 'api::trip.trip'>;
